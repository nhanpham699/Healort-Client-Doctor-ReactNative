                    ...
                    onPress: async() =>  {
                        if(actor == 'doctor'){
                            const dataSaved = {
                                ...
                                body: 'Doctor' + doctorName + ' want to update your re-exam schedule!',
                                status : 0,
                                date: new Date()
                            }
                            console.log(data);
                            await axios.post(host + '/reexams/confirmation', data)
                            ...
                            await axios.post(host + '/reexams/update', data)
                            .then(async(res) => {
                                ...
                                const user = res.data.userId
                                    const dataSaved = {
                                        ...
                                        doctorId: doctor._id,
                                        title: 'Update the re-exam schedule',
                                        body: user.fullname + ' updated the re-xam schedule! Please check your re-exam schedule',
                                        date: new Date()
                                    }
    ...
    async function sendPushNotification(expoPushToken, actor, name) {
        ...
        if(actor == "user"){
            message = {
                to: expoPushToken,
                sound: 'default',
                title: 'Update re-exam the schedule',
                body: name + ' updated re-exam the schedule! Please check your re-exam schedule',
            ...
            message = {
                ...
                sound: 'default',
                title: 'Update the re-exam schedule',
                body: 'Doctor '+ name +' want to update your re-exam schedule!',
                data: { someData: 'goes here' },
              };
        }
